...
public class ScrollContainer extends GameGui implements IBounded {
    ...
    @Override
    public void init() {
        width = bounds.width = minecraft.window.getScaledWidth() - margin.left - margin.right;
        height = bounds.height = minecraft.window.getScaledHeight() - margin.top - margin.bottom;
    ...
    public void render(int mouseX, int mouseY, float partialTicks) {
        ...
        ClippingSpace.renderClipped(margin.left, margin.top, bounds.width, bounds.height, () -> {
    ...
    protected Bounds getContentBounds() {
